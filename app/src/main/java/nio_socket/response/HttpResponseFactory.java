package nio_socket.response;

import nio_socket.fs.FileMetadata;
import nio_socket.html_pack.HTMLDocument;
import nio_socket.utils.Constants.HttpStatus;
...
public final class HttpResponseFactory {
    ...
    public HttpResponse buildCodeResponse(HTMLDocument msg) {
        HttpResponse response = new HttpResponse();
