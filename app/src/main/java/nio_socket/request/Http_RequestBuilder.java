...
import nio_socket.protocol.HttpSession;
...
import nio_socket.protocol.parser.impl.LocaleParser;
import nio_socket.utils.StringUtilities;

public class Http_RequestBuilder implements HttpServletRequest {
...
/*        public Builder withUploadedFiles(final Collection<UploadedFile> uploadedFiles) {
        ...
        //public Builder withInputStream(final ReadableByteChannel channel) {
        //    internal.in = channel;
        //    return this;
        //}
        ...
        public Http_RequestBuilder build() {
            Http_RequestBuilder result = new Http_RequestBuilder();
